...
public class Tank extends GameObject{
    ...
    boolean hasPowerUp; // if has active powerup
    int currentPowerUpTickCount;
   ...
   void setCurrentPowerUp(String currentPowerUp) {
        this.currentPowerUp = currentPowerUp;
   }

    void setCurrentPowerUpTickCount(int currentPowerUpTickCount) {
